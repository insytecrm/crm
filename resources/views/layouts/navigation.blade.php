@php
    $home = tenant() ? route('tenant.dashboard') : route('tenants.index');
@endphp
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- Authentication -->
                        <form method="POST" action="{{ tenant() ? route('tenant.logout') : route('logout') }}">
                            @csrf

                            <x-dropdown-link :href="tenant() ? route('tenant.logout') : route('logout')"
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ tenant() ? route('tenant.logout') : route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="tenant() ? route('tenant.logout') : route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
