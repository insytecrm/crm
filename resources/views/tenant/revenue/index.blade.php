<x-tenant-layout :title="__('Revenue') . ' | InSyte CRM'">
    <div x-data="{ filtersOpen: @js($filter->isActive()) }">
        ...
        <div class="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:items-stretch lg:grid-cols-3">
            <x-tenant.stat-card :label="__('Total Sales')" :value="'₹' . number_format($summary['total_revenue'])" accent="emerald">
                <x-slot:icon>
            ...
            <x-tenant.stat-card :label="__('Sales This Month')" :value="'₹' . number_format($summary['revenue_this_month'])" accent="sky">
                <x-slot:icon>
                    <svg class="size-[18px]" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
            ...
            <x-tenant.stat-card :label="__('Sales This Quarter')" :value="'₹' . number_format($summary['revenue_this_quarter'])" accent="sky">
                <x-slot:icon>
                    <svg class="size-[18px]" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
